...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(812, 624);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        centralwidget->setEnabled(true);
        verticalLayoutWidget = new QWidget(centralwidget);
        verticalLayoutWidget->setObjectName("verticalLayoutWidget");
        verticalLayoutWidget->setGeometry(QRect(-1, -1, 811, 601));
...
"color: rgb(255, 255, 255);"));
        ...
        nextPushButton = new QPushButton(verticalLayoutWidget);
        nextPushButton->setObjectName("nextPushButton");
        nextPushButton->setMinimumSize(QSize(200, 50));
        QFont font;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        nextPushButton->setText(QCoreApplication::translate("MainWindow", "Slede\304\207i korak", nullptr));
    } // retranslateUi
